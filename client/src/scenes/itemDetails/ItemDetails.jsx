...
const ItemDetails = () => {
  ...
  const { itemId } = useParams(); // grabing itemId from the url
  ...
  useEffect(() => {
    getItem();
    getItems();
  }, [itemId]) // eslint_disable-line react-hooks/exhaustive-deps
    ...
    <Box width="80%" m="80px auto">
      <Box display="flex" flexWrap="wrap" columnGap="40px">
        ...
        <Box flex="1 1 50%" mb="40px">
          ...
          <Box m="65px 0 25px 0">
            <Typography variant='h3' mb="10px">{item?.attributes?.name}</Typography>
